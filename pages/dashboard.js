...
export default function Dashboard() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-16">
      <h1 className="text-3xl font-bold mb-6 text-white">Your Free Trial Content Pack</h1>
      ...
      {/* Download button */}
      <a
        href="https://drive.google.com/file/d/1vWnoS3B-khKTV8NMMeBsiiQi-GFKU4mF/view?usp=drive_link"
        target="_blank"
        rel="noreferrer"
