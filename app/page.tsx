      ...
      <section id="features" className="py-20 px-6 text-center bg-black">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="p-6 border border-gold/20 rounded-xl hover:border-gold transition">
            ...
            <p className="text-gray-400">AI-filtered and human-verified trading signals with precision risk-reward ratios.</p>
          </div>
          <div className="p-6 border border-gold/20 rounded-xl hover:border-gold transition">
            <h3 className="text-xl font-semibold mb-3 text-gold">Speed</h3>
            <p className="text-gray-400">Instant alerts to your dashboard and Telegram for fast execution.</p>
          </div>
          <div className="p-6 border border-gold/20 rounded-xl hover:border-gold transition">
            <h3 className="text-xl font-semibold mb-3 text-gold">Transparency</h3>
            <p className="text-gray-400">Real-time performance tracking and monthly win-rate reports.</p>
          </div>
        </div>
      </section>
