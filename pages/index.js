    ...
    <main>
      ...
      <section id="demo" className="max-w-6xl mx-auto px-4 py-16">
        <div className="card flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a className="btn-gold" href="https://drive.google.com/file/d/1vWnoS3B-khKTV8NMMeBsiiQi-GFKU4mF/view?usp=drive_link" target="_blank" rel="noreferrer">📥 Get the Free Pack</a>
        </div>
      </section>
      <FAQ />
